    ...
    return (
      <div className="App">
        <header className="App-header">
          ...
          <Route exact path="/stamp_card_confirmation" render={()=>< StampCardConfirmation stamp_cards={this.state.stamp_cards}/>}/>
          <Route exact path="/stores/:id" render={(routerProps) => < StoreDetail {...routerProps} deals={this.state.deals} store={this.state.currentStore} clickDeal={this.clickDeal}/> } />
